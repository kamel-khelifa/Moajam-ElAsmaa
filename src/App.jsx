...
// Transforms (references) or [sources] into stunning, dark "jewel" tags inline
  ...
  <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6" dir="rtl">
    ...
    <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-stone-50 rounded-[2rem] shadow-2xl flex flex-col md:flex-row animate-in fade-in zoom-in-95 duration-300">
      ...
      <div className="md:w-3/5 p-8 md:p-12 space-y-8 bg-white/60 backdrop-blur-xl">
        ...
        {/* Section: Premium Reference URL Card */}
...
const filteredNames = useMemo(() => {
  ...
  return names.filter(name => {
    ...
    if (selectedLetter !== 'الكل') {
       // Handle 'هـ' visually vs programmatically, and clean the letter for standard Alef mapping
...
return (
  <div className="min-h-screen bg-[#FDFCFB] text-stone-900 font-sans selection:bg-amber-200 selection:text-amber-900" dir="rtl">
    ...
    {/* PREMIUM FONTS INJECTION
      - Alexandria: Ultra-modern, sharp geometric UI font
      - Reem Kufi: Gorgeous, historic architectural Kufic for titles
      - Noto Naskh: Classic poetic serif for meanings
      - Amiri: Classic elegant serif specifically for the names
    */}
    <style>{`
      @import url('https://fonts.googleapis.com/css2?family=Alexandria:wght@300;400;500;600;700;800&family=Amiri:wght@400;700&family=Noto+Naskh+Arabic:wght@400;700&family=Reem+Kufi:wght@400;500;600;700&display=swap');
